...
/// </summary>
public class ContextoVeterinaria(DbContextOptions<ContextoVeterinaria> options) : DbContext(options)
{
    // =========================================================================
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(ContextoVeterinaria).Assembly);

        // ---------------------------------------------------------------------
        // Filtro Global de Soft Delete: Toda entidad EntidadAuditable filtra por Activo == true
        // ---------------------------------------------------------------------
        foreach (var entityType in modelBuilder.Model.GetEntityTypes())
        {
            if (typeof(EntidadAuditable).IsAssignableFrom(entityType.ClrType))
            {
                var parameter = Expression.Parameter(entityType.ClrType, "e");
                var property = Expression.Property(parameter, nameof(EntidadAuditable.Activo));
        ...
        // ---------------------------------------------------------------------
        ConfigurarCatalogos(modelBuilder);
        ConfigurarSeguridad(modelBuilder);
        ConfigurarClientesPacientes(modelBuilder);
        ConfigurarClinicaConsultas(modelBuilder);
    ...
    private static void ConfigurarSeguridad(ModelBuilder builder)
    {
        ...
        {
            b.ToTable("Usuario");
            b.HasIndex(u => u.NombreUsuario)
                .IsUnique();

            b.Property(u => u.NombreUsuario)
                .HasMaxLength(50)
                .IsRequired();

            b.Property(u => u.HashContrasena)
                .HasMaxLength(255)
                .IsRequired();
    ...
    /// </summary>
    private static void ConfigurarClientesPacientes(ModelBuilder builder)
    {
        // Propietario
        builder.Entity<Propietario>(b =>
        {
            ...
            b.Property(p => p.CorreoElectronico)
                .HasMaxLength(100);
    ...
    /// </summary>
    private static void ConfigurarClinicaConsultas(ModelBuilder builder)
    {
        // Consulta
    ...
    /// </summary>
    private static void ConfigurarPagos(ModelBuilder builder)
    {
        // Pago
